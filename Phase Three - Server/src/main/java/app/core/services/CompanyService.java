...
public class CompanyService extends ClientService {
	...
	public Coupon addCoupon(Coupon coupon) throws CouponSystemException {
		...
		try {
			...
			if (companyCoupons.contains(coupFormDb)) {
				...
				System.out.println("'" + comp.getName() + "' added a new Coupon");
				return coupon;
			}
		...
		try {
			...
			if (opt.isPresent()) {
				...
				if (companyCoupons.contains(coup)) {
					...
					System.out.println(couponRepository.save(coup));
					return coup;
				} else {
					throw new CouponSystemException(
	 ...
	 * @throws CouponSystemException
	 */
	public Long deleteCoupon(Long id) throws CouponSystemException {
	...
	public List<Coupon> getCompanyCoupons() throws CouponSystemException {
		...
		try {
			...
			if (companyCoupons.isEmpty()) {
				throw new CouponSystemException("You didn't produce any Coupon/s - Empty");
			} else {
	...
	public List<Coupon> getCompanyCoupons(Category category) throws CouponSystemException {
		...
		try {
			...
			if (companyCouponsByCategory.isEmpty()) {
				throw new CouponSystemException("You didn't produce any Coupon/s from this category: " + category);
			} else {
	...
	public List<Coupon> getCompanyCoupons(double maxPrice) throws CouponSystemException {
		...
		try {
			...
			if (companyCouponsByMaxPrice.isEmpty()) {
				throw new CouponSystemException(
						"You didn't produce any Coupon/s below the price of: " + maxPrice + "$");
			} else {
